...
- Frontmatter version is `4.14.2` on master (customer-only rendering references, direct vision check, earrings are not a ring; 46 scripts) (4.13.8 was the pod's republish of 4.13.7 after a stale publishing folder) (the team listing "jewelry-estimate-desk-testing"). Bump it with every publish.
