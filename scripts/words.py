...
RULES: list[Rule] = [
    ...
    Rule("asks to reschedule", "a meeting they have is being moved; with one booked, any question naming a time",
         lambda words: estimate_record.asks_to_reschedule(words, booked=True),
         yes=[("Something came up for Saturday... Any chance we can do Friday at 4pm?", True),
              ("My mistake, I have the wrong day. Can we do Monday at 3pm?", True), ("Could we do Monday at 11 instead?", True),
              ("Sorry, I meant to say Tuesday.", True)],
         no=["See you Friday at 3pm!", "Does it come in rose gold?", "I can pick it up Friday at 4pm."],
         seen="8 Sep; 9 Sep (the wrong day: 'Can we do Monday at 3pm?' got the questionnaire)"),
    ...
    Rule("an earlier conversation", "'we talked about earlier': the earlier estimate is the base", estimate_record.refers_to_an_earlier_conversation,
         yes=[("Do you remember this emerald earrings we talked about earlier?", True), ("same as the ring you quoted me last month", True),
              ...
              ("Hey remember those sapphire earrings? I want to make a pair for my mom, everything the same but in platinum.", True),
              ("Same as last time but in rose gold", True), ("I'd like another pair like the ones I got from you.", True),
              ("Can you do one more ring like the one you made for my wife?", True), ("The pendant you quoted me in June, I'm ready.", True),
              ("Could I get the same bracelet again?", True), ("I bought a ring from you two years ago and want a matching band.", True)],
         no=["Can you make me earrings?", "we talked about a budget of 5000 with my wife", "I remember you have a shop downtown",
             "I want a pendant like the one on your website", "Something like the attached photo, in 14k", "I'd like a ring like the one pictured below",
             "My grandmother's ring was made by a jeweler in Italy years ago", "Do you have this ring in stock?"],
         seen="9 Sep (More earrings: asked everything again; 'remember those sapphire earrings?': asked everything again)"),
