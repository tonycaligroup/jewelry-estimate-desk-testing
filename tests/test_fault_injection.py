...
KNOWN_GAPS: dict[tuple[int, str, str], str] = {
    ...
    (3, "gmail_send", "crash_after"): "step 2: an uncertain send is verified against Gmail by the desk's own Message-ID, then recorded or resent",
    (3, "gmail_send", "fail_once"): "step 2: an uncertain send is verified against Gmail by the desk's own Message-ID, then recorded or resent",
    (3, "gmail_send", "fail_twice"): "step 2: an uncertain send is verified against Gmail by the desk's own Message-ID, then recorded or resent",
    ...
    (5, "gmail_send", "crash_after"): "step 2: an uncertain send is verified against Gmail by the desk's own Message-ID, then recorded or resent",
    (5, "gmail_send", "fail_once"): "step 2: an uncertain send is verified against Gmail by the desk's own Message-ID, then recorded or resent",
    (5, "gmail_send", "fail_twice"): "step 2: an uncertain send is verified against Gmail by the desk's own Message-ID, then recorded or resent",
    ...
    (7, "calendar_create", "crash_after"): "step 2: write-ahead calendar step; the desk adopts its own event by the estimate id in its description",
    (7, "gmail_send", "crash_after"): "step 2: an uncertain send is verified against Gmail by the desk's own Message-ID, then recorded or resent",
    (7, "gmail_send", "fail_once"): "step 2: an uncertain send is verified against Gmail by the desk's own Message-ID, then recorded or resent",
    (7, "gmail_send", "fail_twice"): "step 2: an uncertain send is verified against Gmail by the desk's own Message-ID, then recorded or resent",
}
